...
const Header = () => {
  return (
    <header className="bg-[url(assets/images/landingpage/header/bg.png)] gap-10 max-sm:h-[600px] md:h-[900px] lg:h-[900px] xl:h-[860px] 2xl:h-[1000px] max-sm:bg-cover lg:bg-contain relative items-center bg-no-repeat flex flex-col  overflow-hidden">
      <Nav />
