    ...
    <ScrollElement>
      ...
      >
        <div className="h-full flex  gap-4">
          ...
          >
            <Link className="hover:text-[#69b1ff] transition-all" target="_blank" to="https://www.linkedin.com/in/npouriaa/">
              <FaLinkedin size={21} />
            </Link>
            <Link className="hover:text-[#69b1ff] transition-all" target="_blank" to="https://github.com/npouriaa">
              <FaGithub size={21} />
            </Link>
            <Link className="hover:text-[#69b1ff] transition-all" target="_blank" to="https://t.me/npouriaa">
              <FaTelegram size={21} />
            </Link>
          </div>
        </div>
